...
--algorithm AsyncInterfaceChan {
  variables 
    \* chan = [val |-> 0..100, rdy |-> 0..1, ack |-> 0..1];
    \* chan := [val \in 0..100, rdy \in 0..1, ack \in 0..1];
      ...
      variable oldrdy;
    {
      ...
      s02:    chan.rdy := 1 - chan.rdy || chan.val := 44;  \* TODO: how choose a random val?
              oldrdy := chan.rdy;
...
s02 == /\ pc["send"] = "s02"
       ...
       /\ Assert((chan'.rdy # chan'.ack), 
                 "Failure of assertion at line 30, column 15.")
...
r02 == /\ pc["recv"] = "r02"
       ...
       /\ Assert((chan'.rdy = chan'.ack), 
                 "Failure of assertion at line 49, column 15.")
